...
6. If the Windows 10 PC itself feels slow, follow the [Windows 10 smooth PC setup](windows-10-performance-setup.md) checklist before changing Roblox code.
7. Record any profile links, asset IDs, game IDs, manual setup steps, FPS targets, and test results in your change notes.
8. Publish only after confirming that the change works in your own experience and does not give unfair access in other creators' servers.
...
- Windows 10 setup checks that use official updates, safe graphics settings, startup-app cleanup, and network troubleshooting.
...
- Unknown "optimizer" downloads, registry cleaners, or modified Roblox clients that promise free FPS.
